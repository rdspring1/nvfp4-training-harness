...
leading 85% of layers. Same command, shape and seed as the experts-only arm in
`../deepseek_v3_16b_fsdp4_ep4_nvfp4_tail15_scalefix_compile_200m_gbs128/`, so
this is a one-variable A/B against it: the FFN Linears are the only difference.
